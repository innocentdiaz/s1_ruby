...
Gem::Specification.new do |spec|
  ...
  spec.description = <<~DESC
    ...
    code can branch on directly.     Providers ship for TypeSafe's jev (hosted), any System One HTTP server
    (Protocol), and cua-s1-forms (local); a Stub answers in tests.
  DESC
